...
const Footer = () => {
      return (
            <footer className="w-full bg-blue-500 text-white container mx-auto">
                  <div className="container mx-auto px-10 py-10 flex flex-col sm:flex-row justify-between gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                              ...
                              <p className="text-sm text-white/80">
                                    DocAppoint
                                    <br />
                                    Doctor Appointment Booking System since 2026
                              </p>
                        </div>

                        {/* Social Nav */}
                        <nav className="flex flex-col gap-3">
                              <h6 className="text-xs font-semibold uppercase tracking-widest text-white/60">
                                    Social
                              </h6>
